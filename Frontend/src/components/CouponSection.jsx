export default function CouponSection({ couponCode }) {
  return (
    <div className="card">
      ...
      <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-center justify-between">
        <div className="flex gap-2">
          ...
          <button className="btn-primary self-end h-[38px]">Apply</button>
        </div>
        ...
        <div className="bg-brand-success-bg border border-green-200 rounded p-3 flex items-start gap-3 mt-4 sm:mt-0 w-full sm:w-auto">
          ...
          <div>
            ...
            <p className="text-brand-success-text text-xs opacity-90 mt-1">{couponCode} - ₹ 500 off on eligible purchase.</p>
          </div>
        </div>
      </div>
